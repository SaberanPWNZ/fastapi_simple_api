...
Revision ID: 487412828413
Revises: 
Create Date: 2024-08-06 19:05:42.997919
...
def upgrade() -> None:
    ...
    sa.Column('partner_price', sa.Float(), nullable=False),
    sa.Column('rrp_price', sa.Float(), nullable=False),
